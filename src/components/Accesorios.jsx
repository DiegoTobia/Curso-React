...
const Accesorios = () => {
    ...
    const [productosFiltrados, setProductosFiltrados] = useState(data.filter(accesorio => accesorio.tipo === "accesorios"));
    const [productosOrdenados, setProductosOrdenados] = useState(data.filter(accesorio => accesorio.tipo === "accesorios"));
    ...
    useEffect(() => {
        ...
        let filtrados = data.filter(producto => producto.tipo === "accesorios");
